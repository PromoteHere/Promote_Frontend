...
// Step configuration
const steps = [
  { title: 'Booking Mode', content: <BookingMode selectedName={setSelectedName}/> },
  { title: 'Select Booking', content: isSelectedName === 'E-Posters :' ? <Bookposter/> : <BookingTable /> },
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-gray-100">
            ...
            <div className="w-full max-w-5xl p-12 bg-white/40 backdrop-blur-lg rounded-3xl shadow-xl border border-white/50 transition-all hover:shadow-2xl">
                ...
                <Spin spinning={loading} size="large" tip="Loading..." className="block">
